...
################################
#TODO:
#Josh: ridge regression, lasso regression?
#

fifa_training_control <- trainControl(method = "cv", number = 5)

usefulDataset <- data.frame(cbind(fifa_targets_numerical, fifa_predictors_numerical))

linearModel <- lm(
  fifa_targets_numerical ~ ., data = usefulDataset
)

...
elastic_net_fit <- train(fifa_predictors_numerical, fifa_targets_numerical, preProcess = c("center", "scale", "BoxCox", "pca"), method = 'enet')
MARS_fit <- train(fifa_predictors_numerical, fifa_targets_numerical, preProcess = c("center", "scale", "BoxCox", "pca"), method = 'bagEarth')
